...
class Uploadobject_template extends Template implements I_Template
{
    ...
    public function get_body_header($data)
    {
        if (!\Dcs\Vendor\Core\Models\User::isAuthorized()) {
            throw new \Dcs\Vendor\Core\Models\DcsException('anonymous user: Uploadobject closed');
        }    
        $prefix = '';
        $context = DcsContext::getcontext();
        ...
        if (\Dcs\Vendor\Core\Models\User::isAdmin()) {    
            $result .= "<li>\n"
                     . "<a href=\"/CONFIG/\">\n"
    ...
    public function get_body_script($data)
    {
        ...
        $result = "<script type=\"text/javascript\" src=\"/public/js/jquery-3.2.1.js\"></script>\n"
                ...
                . "<script type=\"text/javascript\" src=\"/public/js/uploadobject/uploadobject.js\"></script>\n";
...
//                            . " onchange=\"$(this).trigger('dcs_onchange')\""
                    ...
                    $result .= "<div class=\"form-group col-sm-6\" style=\"padding-right: 10px;\">"
