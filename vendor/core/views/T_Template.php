...
trait T_Template {
    ...
    {
        $this->template->get_top();
        $this->get_head();
        $this->get_body_header($data);
        $this->get_body_main($data);
        $this->get_body_footer();
        $this->get_body_script();
        $this->get_bottom();
    }
    public function head_view()
    {
        ...
        $this->template()->get_css_stylesheets();
        echo "<link href=\"/public/css/normalize.css\" rel=\"stylesheet\" type=\"text/css\">";
        echo "<link href=\"/public/css/materialize.min.css\"  media=\"screen,projection\" rel=\"stylesheet\" type=\"text/css\">";      
