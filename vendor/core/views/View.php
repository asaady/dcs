...
class View
{
    ...
    public function generate($context, $template_view, $data = null)
    {
        include filter_input(INPUT_SERVER, 'DOCUMENT_ROOT', FILTER_SANITIZE_STRING)."/vendor/core/views/".$template_view;
    }
    ...
    public static function outContent($context, $data)
    {
        ...
        for($i=0, $props=$data['PLIST'], $size=count($props); $i<$size; $i++)
        {
            ...
            if($t['rank']%2)
            {
                self::outfield($t,'col-md-4',$context['MODE']);
                if (($i+1) < $size)
                {
            ...
            {
                self::outfield($t,'col-md-offset-4 col-md-4',$context['MODE']);
            }
        }
    ...
    public static function outContentToPrint($context, $data)
    {
        echo "<div class=\"row\">";
        $props=$data['PLIST'];
        $size=count($props);
    ...
    public static function out_navbar($context,$data)
    {        
        echo "<div class=\"navbar navbar-default\" role=\"navigation\">
               <div class=\"container-fluid\">";
        if (($context['MODE'] === 'CONFIG')||(($context['ACTION'] !== 'EDIT')&&($context['ACTION'] !== 'SET_EDIT')))
        {
           echo "<div class=\"navbar-header col-xs-12 col-sm-12 col-md-12\">
                        ...
                        <div class=\"nav collapse navbar-collapse\" id=\"b-menu-1\">
                            ...
                            {    
                                ...
                                {    
                                  echo "<li><a href=\"$context[PREFIX]/$ct[ID]\">$ct[SYNONYM]</a></li>";
                                }
                                if (\Dcs\Vendor\Core\Models\User::isAdmin()&&($context['MODE'] !== 'CONFIG'))
                                {    
                                    echo "<li>";
                                    echo "<a href=\"/config\">";
        ...
        echo "<div class=\"navbar-inner\">
               <div class=\"col-xs-12 col-sm-12 col-md-12\">
                <ol class=\"breadcrumb\">";
                    ...
                    {    
                      echo "<li><a href=\"$context[PREFIX]/$key\">$val</a></li>";
                    }
                echo "</ol>
                    </div>
                </div> 
