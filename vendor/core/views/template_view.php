...
<head>
    ...
    <?php 
        echo "<title>$context[TITLE]</title>";
    ?>
    <!-- css stylesheets -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    <header>
        <?php
        Dcs\Vendor\Core\Views\View::out_navbar($context,$data);
        ?>                        
    </header>    
    <main>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <div class="container-fluid dcs_object">
                        <?php
                        echo "<input class=\"form-control\" name=\"curid\" type=\"hidden\" value=\"$context[CURID]\">";
                        echo "<input class=\"form-control\" name=\"version\" type=\"hidden\" value=\"$data[version]\">";
                        echo "<input class=\"form-control\" name=\"page\" type=\"hidden\" value=\"$context[PAGE]\">";
                        echo "<input class=\"form-control\" name=\"itemid\" type=\"hidden\" value=\"$context[ITEMID]\">";
                        echo "<input class=\"form-control\" name=\"mode\" type=\"hidden\" value=\"$context[MODE]\">";
                        echo "<input class=\"form-control\" name=\"action\" type=\"hidden\" value=\"$context[ACTION]\">";
                        ...
                        echo "<input class=\"form-control\" name=\"filter_val\" type=\"hidden\" value=\"$context[PARAM]\">";
